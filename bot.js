...
${prefix}helpLp ⇏    **  | لعرض الاوامر العامه**  

${prefix}helpLa ⇏    **  | لعرض الاوامر الاداريه**  
 
${prefix}helpLg ⇏    **  | لعرض الاوامر الالعاب**  

${prefix}helpLm ⇏    **  | لعرض الاوامر الاغاني**  
...
**============ **
  ** Lmove @user |  لسحب الشخص الى روومك** :confused: 

  ** Lbc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** Lrole @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** Lroleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** Lrole all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** Lrole humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **Lrole bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** Lschannel | اضهار الشات المخفية**:blush: 

  ** Lhchannel | اخفاء الشات**:arrow_heading_down: 

  ** Lclr <numbr> | مسح الشات بعدد**:information_source: 

  ** Lclear | مسح الشات ** :recycle: 

  ** Lmute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** Lunmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** Lkick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** Lban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** -mutechannel | تقفيل الشات**:no_entry:

  ** Lunmutechannel | فتح الشات**:on:   

  ** Ldc | مسح كل الرومات**

  ** Ldr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** Lct <name> | انشاء شات**:rolling_eyes:

  ** Lcv <name> | انشاء رووم فويس**:crown:

  ** Ldelet <name> | مسح الشات او الرووم فويس**

  ** Lccolors <number> | ينشا لك الوان مع كم الوان تبي**
...
`)
  ...
  ** Lrps | حجر ورقة مقص ** :video_game:

  ** Lspeed | اسرع كتابن ** :video_game:

  ** Lquas | اسئلة عامة ** :video_game:

  ** Lنكت | نكت ** :video_game:

  ** Lلعبة فكك | فكك ** :video_game:

  ** Lلعبة عواصم | عواصم** :video_game:

  ** Lلعبة كت تويت | كت تويت ** :video_game:

  ** Lroll | قرعة راندوم** :video_game:

  ** Lلو خيروك بطريقة حلوة | لوخيروك

  ** Lلعبة مريم | مريم** :video_game: 
  
  ** Lفوائد نصائح | هلتعلم ** :video_game: 
  
  ** Lيعطيك عقابات قاسية |عقاب** :video_game: 
   `)
   message.author.sendEmbed(embed)
  ...
  ** Lplay | لتشغيل اغنية برابط او بأسم** 

  ** Lskip | لتجآوز الأغنية الحآلية**

  ** Lpause | إيقآف الأغنية مؤقتا**

  ** Lresume | ل**موآصلة الإغنية بعد إيقآفهآ مؤقتا

  ** Lvol | لتغيير درجة الصوت 100 - 0**

  ** Lstop | لإخرآج البوت من الروم**

  ** Lnp | لمعرفة الأغنية المشغلة حآليا**

  ** Lqueue | لمعرفة قآئمة التشغيل**
...
**============ **
  ...
  ** Lallbots | لعرض جميع البوتات الي بالسيرفر** :robot: 

  ** Lserver |يعرض لك معلومات عن السيرفر**:fire: 

  ** Lbot | يعرض لك كل معلومات البوت**:computer: 
  
  ** Lskin <name> | يعرض لك سكنك بماين كرافت**:blush:

  ** Lcount | يعرض لك عدد الاشخاص بالسيرفر بدون بوتات** :information_source:

  ** Linvites | يعرض لك  عدد انفايتاتك بالسيرفر ** :microscope: 

  ** Linvite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 

  ** Lcal | اله حاسبة**:slot_machine: 

  ** -trans <language> <any thing> | يترجم لك الي تبيه من اي لغة**:writing_hand: 

  ** Lshort | يختصر لك رابط كبير الى رابط صغير**:mortar_board: 

  ** Ltag | يكتب لك الكلمة بشكل جميل وكبير**:sunglasses: 

  ** Lgoogle | للبحث في قوقل عن طريق الدسكورد**:desktop: 

  ** Lperms | يعرض لك برمشناتك بالسيرفر**:pushpin: 

  ** Lza5 | يزخرف لك كلمة او جملة**:hearts: 

  ** Lrooms | يعرض لك كل الرومات الي بالسيرفر مع عددها**:rocket: 

  ** Lroles | يعرض لك كل الرانكات بالسيرفر بشكل جميل**

  ** Lemojilist | يعرض لك كل الايموجيات الي بالسيرفر**:cry: :smile: :joy: 

  ** Lsay | يكرر الكلام الي تكتبو**:sparkles: 

  ** Limage | صورة السيرفر**:bust_in_silhouette: 

  ** Lmembers | يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص**:selfie: 

  ** Lprofile | ليعرض البرفايل حقك** 

  ** Lbans | عدد الاشخاص المبندة **:no_entry: 

  ** Lavatar | صورتك او صورة الي تمنشنو**:bust_in_silhouette:

  ** Lembed | يكرر الي تقولو بشكل حلو**:small_blue_diamond: 

  ** Lemoji <any things> | لتحويل اي كلمه تقولها الي ايموجي**:small_orange_diamond: 

  ** Linv | لدعوة البوت الى سيرفرك**:black_circle: 

  ** Lsupport | سيرفر الدعم**:wrench:  :envelope_with_arrow: 
  
  ** Lcontact | ارسال اقتراح او لمراسلة صاحب البوت**
...
client.on('message', message => {
 if (message.content.startsWith("Lعقاب")) {
...
'*** انا لست الحوت الازرق كما يدعون ***',
 ...
 client.on('message', message => {
 if (message.content.startsWith('Lمريم{
...
if (message.author.id !== '401441334864510986') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.users.get("468780726352085002").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
    if (message.content.startsWith("Lbans")) {
...
client.on('message', message => {
        if (message.content === "Linv") {
            if(!message.channel.guild) return;
        let embed = new Discord.RichEmbed()
        .setAuthor(` ${message.author.username} `, message.author.avatarURL)      
        .setTitle(`:small_orange_diamond: اضغط هنا `)
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=519169563045134338&scope=bot&permissions=1`)
        .setThumbnail(" https://discordapp.com/oauth2/authorize?client_id=519169563045134338&scope=bot&permissions=1")        
     message.channel.sendEmbed(embed);
       }
   });
...
if (!profile[getvalueof.id]) profile[getvalueof.id] = {points: 0,reps: "NOT YET",credits: 1, level: 1,tite: "HypeLC User", rep: 0, lastDaily: "NOT COLLECTED"};
            ...
            ctx.drawImage(ground, 0, 0, 300, 300); // حجم الصورة
                ...
                let url = getvalueof.displayAvatarURL.endsWith("Lwebp") ? getvalueof.displayAvatarURL.slice(5, -20) + "Lpng" : getvalueof.displayAvatarURL;
...
.setDescription(`***السيرفرات الموجودة فيه البوت ${client.guilds.size} \n \n${client.guilds.map(guilds => `- ${guilds.name}`).join('\n')}***`)
         message.channel.sendEmbed(Embed11)
			      ...
			      client.on("message", (message) => {
    if (message.content.startsWith('Ldelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
const sWlc = {}
const premium = ['401441334864510986', '', '', '']
client.on('message', message => {
var prefix = "L";
